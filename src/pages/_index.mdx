...
| package               | description                                   |
| --------------------- | --------------------------------------------- |
| [@connect2ic/core](https://github.com/Connect2IC/connect2ic/tree/main/packages/core)      | Core logic, providers, assets and utilities  |
...
- Discord: https://discord.gg/4kqMVknpgZ
